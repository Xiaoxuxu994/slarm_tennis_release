...
ROWS = [
    ...
    ("catch position inplane med", "catch_position_inplane",           "median", True),
    ("catch position inplane p95", "catch_position_inplane",           "p95",    True),
    ("catch position axial med",   "catch_position_axial",             "median", True),
